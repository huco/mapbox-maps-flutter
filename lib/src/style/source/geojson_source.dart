...
class GeoJsonSource extends Source {
  ...
  Future<Map<String, dynamic>?> get clusterProperties async {
    return _style?.getStyleSourceProperty(id, "clusterProperties").then((value) {
      if (value.value != null) {
        return Map<String, dynamic>.from(value.value as Map<dynamic, dynamic>).cast<String, dynamic>();
      } else {
        return null;
      }
    });
  ...
  Future<TileCacheBudget?> get tileCacheBudget async {
    return _style?.getStyleSourceProperty(id, "tile-cache-budget").then((value) {
      if (value.value != null) {
